...
src_prepare() {
	epatch "${FILESDIR}/${P}-allow-incompatible-function-casts.patch"
	epatch "${FILESDIR}/${P}-fix-invalid-type-qualifers.patch"
	epatch "${FILESDIR}/${P}-no-cmake-python-tools-install.patch"
	epatch "${FILESDIR}/${P}-use-const-ref-when-catching-exceptions.patch"
